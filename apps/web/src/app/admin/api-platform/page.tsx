...
type ApiSettings = { commission_rate_bp: number; quota_warning_thresholds: number[]; feature_flags: Record<string, boolean>; plan_limits: Record<string, { max_keys: number; quota: number; rate_limit: number; price: number }> };
